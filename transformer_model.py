...
def train_baseline():
    ...
    try:
        ...
        # Standard random split without stratification to accommodate rare single-observation classes
        ...
        # zero_division=0 gracefully handles unpredicted classes without throwing warnings
